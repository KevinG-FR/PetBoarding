...
namespace PetBoarding_Persistence.Migrations
{
    ...
    [Migration("20250906202708_AddEmailUniqueConstraint")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetBoarding_Domain.Baskets.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Baskets", "PetBoarding");
                });

            modelBuilder.Entity("PetBoarding_Domain.Baskets.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PetBoarding_Domain.Payments.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Payments", "PetBoarding");
                });
            ...
            modelBuilder.Entity("PetBoarding_Domain.Prestations.Prestation", b =>
                {
                    ...
                    b.HasIndex("CategorieAnimal", "Libelle")
                        .HasDatabaseName("idx_prestations_categorie_libelle");

                    b.HasIndex("EstDisponible", "CategorieAnimal")
            ...
            modelBuilder.Entity("PetBoarding_Domain.Reservations.ReservationSlot", b =>
                {
                    ...
                    b.HasIndex("AvailableSlotId", "ReleasedAt")
            ...
            modelBuilder.Entity("PetBoarding_Domain.Baskets.Basket", b =>
                {
                    b.HasOne("PetBoarding_Domain.Payments.Payment", "Payment")
                        .WithMany()
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PetBoarding_Domain.Users.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("PetBoarding_Domain.Baskets.BasketItem", b =>
                {
                    b.HasOne("PetBoarding_Domain.Baskets.Basket", null)
                        .WithMany("Items")
