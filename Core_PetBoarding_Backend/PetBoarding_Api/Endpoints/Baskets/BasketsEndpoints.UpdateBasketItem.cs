...
using PetBoarding_Application.Core.Baskets.UpdateBasketItem;
using PetBoarding_Api.Dto.Baskets;

public static partial class BasketsEndpoints
{
    private static async Task<IResult> UpdateBasketItem(
        Guid prestationId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var command = new UpdateBasketItemCommand(userId, prestationId, request.Quantity);
